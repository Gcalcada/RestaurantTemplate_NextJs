...
export default function MenuItem({ name, description, price, image, addToCart }) {
    return (
      <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
        <Image width={200} height={200} src={image} alt={name} className="w-full h-48 object-cover rounded-lg mb-4" />
