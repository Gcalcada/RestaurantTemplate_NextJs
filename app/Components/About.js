      ...
      <div className="max-w-7xl mx-auto grid gap-8 md:grid-cols-2 md:items-center md:gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-base sm:text-lg mb-4 sm:mb-6 leading-relaxed">
            At our restaurant, we believe in bringing the freshest ingredients
            and authentic flavors to your table. Our chefs are passionate about
            crafting delicious dishes that will make your dining experience
            unforgettable.
          </p>
          <p className="text-base sm:text-lg leading-relaxed mb-4">
            Join us for an experience where tradition meets innovation, and
            every dish is crafted with love and expertise. We are committed to
            providing a memorable meal that you will want to relive time and
            time again!
          </p>
