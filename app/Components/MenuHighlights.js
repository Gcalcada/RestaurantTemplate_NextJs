        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8  text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mx-auto max-w-screen-lg ">
                {menuItems.map((item, index) => (
                    ...
                    <div key={index} className=" p-4 sm:p-6 rounded-lg shadow-lg dark:shadow-dark  bg-white mx-4 ">
                        ...
                        <p className="mt-4 text-lg sm:text-xl font-semibold text-gray-600">${item.price}</p>
                    </div>
                ))}
            </div>
        </section>
